...
# coding=utf-8
# Django settings for slimer project.
import os
import uuid
...
SECRET_KEY = 'django-quickstart-ca480978-5c52-4736-9321-deed0acd8c4f'
...
ROOT_URLCONF = 'slimer.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'slimer.wsgi.application'
